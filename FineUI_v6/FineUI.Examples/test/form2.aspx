<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form2.aspx.cs"
    Inherits="FineUI.Examples.form.form2" %>
    ...
    <form id="_form1" runat="server">
        ...
        <%--<f:Form Width="600px" BodyPadding="5px" ID="Form1" LabelWidth="100px" EnableCollapse="true"
            ...
            <Rows>
                ...
                <f:FormRow ColumnWidths="50% 50%">
                    <Items>
                        <f:DropDownList ID="DropDownList1" runat="server" Label="下拉列表" MaxLength="1" Required="true" ShowRedStar="true" AutoSelectFirstItem="false">
