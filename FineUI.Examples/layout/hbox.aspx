    ...
    <form id="form1" runat="server">
        ...
        <x:Panel ID="Panel2" runat="server" Height="250px" Width="850px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
            ...
            <Items>
                ...
                <x:Panel ID="Panel3" Title="面板2" Width="150px"
                ...
                <x:Panel ID="Panel4" Title="面板3" BoxFlex="2" runat="server"
        ...
        <x:Panel ID="Panel5" runat="server" Height="250px" Width="850px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
            ...
            <Items>
                <x:Panel ID="Panel6" Title="面板1" Width="200px"
                    runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="false">
                    <Items>
                ...
                <x:Panel ID="Panel7" Title="面板2" Width="200px"
                    runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="false">
                    <Items>
                ...
                <x:Panel ID="Panel8" Title="面板3" Width="200px"
        ...
        <br />
        <br />
        <x:Panel ID="Panel9" runat="server" Height="250px" Width="850px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
            ...
            <Items>
                <x:Panel ID="Panel10" Title="面板1" Width="200px"
                    runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="false">
                    <Items>
                ...
                <x:Panel ID="Panel11" Title="面板2" Width="200px"
                    runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="false">
                    <Items>
                ...
                <x:Panel ID="Panel12" Title="面板3" Width="200px"
                    BoxMargin="0" runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="false">
                    <Items>
        ...
        <br />
        <br />
        <x:Panel ID="Panel13" runat="server" Height="250px" Width="850px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
            ...
            <Items>
                <x:Panel ID="Panel14" Title="面板1" Width="200px"
                ...
                <x:Panel ID="Panel15" Title="面板2" Width="200px" Height="150px"
                    runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="false">
                    <Items>
                ...
                <x:Panel ID="Panel16" Title="面板3" Width="200px"
        ...
        <br />
        <br />
        <x:Panel ID="Panel17" runat="server" Height="250px" Width="850px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
            ...
            <Items>
                <x:Panel ID="Panel18" Title="面板1" Width="200px"
                    Height="100px" runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="false">
                    <Items>
                ...
                <x:Panel ID="Panel19" Title="面板2" Width="200px" Height="150px"
                    runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="false">
                    <Items>
                ...
                <x:Panel ID="Panel20" Title="面板3" Width="200px"
                    BoxMargin="0" Height="200px" runat="server" BodyPadding="5px" ShowBorder="true"
                    ShowHeader="false">
                    <Items>
