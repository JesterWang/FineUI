...
<body>
    <form id="form1" runat="server">
        ...
        <x:TabStrip ID="TabStrip1" Width="850px" Height="350px" EnableTabCloseMenu="true" EnableFrame="true"
            ShowBorder="true" ActiveTabIndex="1" runat="server">
            <Tabs>
                <x:Tab ID="Tab1" Title="标签一" EnableClose="false" BodyPadding="5px" runat="server">
                    <Items>
                        <x:Label ID="Label5" Text="标签一中的文本" runat="server" />
                    </Items>
                </x:Tab>
                <x:Tab ID="Tab2" Title="标签二" BodyPadding="5px" EnableClose="true" runat="server">
                    <Items>
                        <x:Label ID="Label4" Text="标签二中的文本" runat="server" />
                    </Items>
                </x:Tab>
                <x:Tab ID="Tab3" Title="标签三" Hidden="true" BodyPadding="5px" EnableClose="true" runat="server">
                    <Items>
                        <x:Label ID="Label3" Text="标签三中的文本" runat="server" />
                    </Items>
                </x:Tab>
                <x:Tab ID="Tab4" Title="标签四" BodyPadding="5px" EnableClose="true" runat="server">
                    <Items>
                        <x:Label ID="Label2" Text="标签四中的文本" runat="server" />
                    </Items>
                </x:Tab>
                <x:Tab ID="Tab5" EnableClose="true" Title="标签五" BodyPadding="5px" runat="server">
                    <Items>
