    ...
    <form id="form1" runat="server">
        ...
        <x:Grid ID="Grid1" Title="表格" EnableFrame="true" EnableCollapse="true" PageSize="5" ShowBorder="true" ShowHeader="true"
            ...
            <PageItems>
                ...
                <x:Button Text="清空数据" runat="server" ID="btnClearData" OnClick="btnClearData_Click">
                </x:Button>
                <x:Button Text="重新绑定数据" runat="server" ID="btnRebind" Icon="Reload" OnClick="btnRebindData_Click">
                </x:Button>
